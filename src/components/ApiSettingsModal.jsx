...
const PRESETS = [
  ...
  },
  {
    ...
    desc: '超长上下文与极速响应 (gemini-2.5-pro/flash)',
    icon: '✨',
  },
  {
    name: 'Anthropic Claude (兼容中转/OneAPI)',
    baseUrl: 'https://api.anthropic.com/v1',
    defaultModel: 'claude-3-7-sonnet',
    desc: '极强文笔与逻辑深度 (claude-3-7-sonnet)',
    icon: '🎭',
  },
  {
    name: 'OpenAI 兼容中转 / OneAPI',
    baseUrl: 'https://api.your-proxy.com/v1',
    defaultModel: 'gpt-4o',
    desc: '第三方中转代理 / NewAPI / 聚合接口',
    icon: '🔄',
  },
  {
  ...
  },
  {
    ...
    desc: '智谱开放平台 (glm-4-plus / glm-4-flash)',
    icon: '🔮',
  },
  {
